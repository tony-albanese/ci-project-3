...
- [UI Design](#ui-design)
  * [Features Heroku Version App](#features-heroku-version-app)
    + [Instructions](#instructions)
    + [Data Scrolling](#data-scrolling)
    + [Data Entry](#data-entry)
    + [Product / Reactant List](#product---reactant-list)
    + [Clear / Reset](#clear---reset)
    + [Chem Report](#chem-report)
  * [Features - Textual App](#features---textual-app)
    + [Scrollable Data Table](#scrollable-data-table)
  ...
  * [Algorithm Design](#algorithm-design)
    ...
    + [Scrolling Data Table (Heroku App)](#scrolling-data-table--heroku-app-)
    + [Searching Data Table (Heroku App)](#searching-data-table--heroku-app-)
    + [Validation of User Input (Heroku App)](#validation-of-user-input--heroku-app-)
    + [Creation of Data Table (Textual App)](#creation-of-data-table--textual-app-)
    + [Handling and Validation of User Input (Textual App)](#handling-and-validation-of-user-input--textual-app-)
    + [Querying Data](#querying-data)
    + [Event Handling (Textual App)](#event-handling--textual-app-)
    + [Calculation of Quantities (Both Textual and Heroku Versions)](#calculation-of-quantities--both-textual-and-heroku-versions-)
- [Testing](#testing)
  * [Manual Testing Heroku App](#manual-testing-heroku-app)
  * [Manual Testing Textual App](#manual-testing-textual-app)
...
- [Deployment](#deployment)
  ...
  * [Binary Executables](#binary-executables)
    + [Creating the Binaries](#creating-the-binaries)
- [Version Control Strategy](#version-control-strategy)
  * [VCS in PyCharm](#vcs-in-pycharm)
- [Credits](#credits)
